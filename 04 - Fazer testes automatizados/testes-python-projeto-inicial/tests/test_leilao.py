...
class TestLeilao(TestCase):
    ...
    def setUp(self):
        self.usr_ruan = Usuario("Ruan", 5000)
        self.usr_cinthia = Usuario("Cinthia", 5000)
    ...
    def test_nao_deve_permitir_que_o_lance_seja_menor_que_o_anterior(self):
    ...
    def test_deve_retornar_o_menor_e_maior_lance_quando_possuir_tres_lances(self):
        usr_nayara = Usuario("Nayara", 5000)
    ...
    def test_deve_adicionar_dois_lances_seguidos_da_mesma_pessoa(self):
        segundo_lance_local = Lance(self.usr_cinthia, 4000)
        self.celular_leilao.guardar_lance(self.primeiro_lance)
